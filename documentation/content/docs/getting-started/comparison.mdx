---
title: Pipeline vs Promise vs Effect
description: Side-by-side code comparison showing how Pipeline reduces boilerplate vs Promises and raw Effect.
---
...
<Tabs items={['Pipeline (5 lines)', 'Promise (17 lines)', 'Raw Effect (21 lines)']} groupId="comparison">
  <Tab value="Pipeline (5 lines)">
    ```typescript
...
<Tabs items={['Pipeline (4 lines)', 'Promise (6 lines)', 'Raw Effect (11 lines)']} groupId="comparison">
  <Tab value="Pipeline (4 lines)">
    ```typescript
...
<Tabs items={['Pipeline (3 lines)', 'Promise (14 lines)', 'Raw Effect (6 lines)']} groupId="comparison">
  <Tab value="Pipeline (3 lines)">
    ```typescript
...
<Tabs items={['Pipeline (10 lines)', 'Promise (13 lines)', 'Raw Effect (19 lines)']} groupId="comparison">
  <Tab value="Pipeline (10 lines)">
    ```typescript
...
<Tabs items={['Pipeline (10 lines)', 'Promise (40+ lines)', 'Raw Effect (15 lines)']} groupId="comparison">
  <Tab value="Pipeline (10 lines)">
    ```typescript
...
<Tabs items={['Pipeline (6 lines)', 'Promise (13 lines)', 'Raw Effect (10 lines)']} groupId="comparison">
  <Tab value="Pipeline (6 lines)">
    ```typescript
    await api
...
<Tabs items={['Pipeline (4 lines)', 'Promise (7 lines)', 'Raw Effect (10 lines)']} groupId="comparison">
  <Tab value="Pipeline (4 lines)">
    ```typescript
